                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" id="image_book" name="image_book" class="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-[#8C7155] focus:border-[#8C7155] sm:text-sm" required>
                        </div>
